...
public class Ticketview extends javax.swing.JFrame {
        ...
        try {  
           ...
           //  Connection connection = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=lab10;integratedSecurity=true");  
            ...
            "databaseName=TrainTicketingSystem;");
             ...
             ResultSet rs = statement.executeQuery("select * from ticketdetails");  
    ...
    private void initComponents() {
        ...
        ticketviewtable = new javax.swing.JTable();
        ...
        textlabel.setText("Ticket Details Table");
        getContentPane().add(textlabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(437, 54, 380, 50));

        ticketviewtable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Train ID", "Ticket ID", "Price", "Class"
            }
        ) {
        ...
        jScrollPane1.setViewportView(ticketviewtable);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(232, 150, 740, 90));
        ...
        getContentPane().add(backbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 370, 220, 60));
    ...
    private javax.swing.JTable ticketviewtable;
